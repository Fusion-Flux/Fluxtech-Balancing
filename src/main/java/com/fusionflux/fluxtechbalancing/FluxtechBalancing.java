...
public class FluxtechBalancing {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "fluxtechbalancing";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "fluxtechbalancing" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "fluxtechbalancing" namespace
    ...
    public static final DeferredItem<Item> SUPERHEATEDIRON = ITEMS.registerSimpleItem("superheated_iron", new Item.Properties());

    public static final DeferredItem<Item> DOUBLEGOLD = ITEMS.registerSimpleItem("double_gold", new Item.Properties());
    public static final DeferredItem<Item> SUPERHEATEDGOLD = ITEMS.registerSimpleItem("superheated_gold", new Item.Properties());

    public static final DeferredItem<Item> DOUBLECOPPER = ITEMS.registerSimpleItem("double_copper", new Item.Properties());
    public static final DeferredItem<Item> SUPERHEATEDCOPPER = ITEMS.registerSimpleItem("superheated_copper", new Item.Properties());
    ...
    public FluxtechBalancing(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (FluxtechBalancing) to respond directly to events.
